...
%% 
A = [4.9176, 1.0, 3.4720, 0.9980, 1.0, 7, 4, 42, 3, 1, 0;
...
A = [ones(28,1),A];
b = [25.9; 29.5; 27.9; 25.9; 29.9; 29.9; 30.9; 28.9; 84.9; 82.9; 35.9; 31.5; 31.0; 30.9; 30.0; 28.9; 36.9; 41.9; 40.5; 43.9; 37.5; 37.9; 44.5; 37.9; 38.9; 36.9; 45.8; 41.0];
%%
sol = LS_sol(A,b);       % 最小二乘求解
e3 = norm(A*sol - b)     % 计算残向量2-范数
[reg_sol,~] = LUcol_sol(A'*A,A'*b); % 正则化方法求解最小二乘
e4 = norm(A*reg_sol - b) % 计算残向量2-范数